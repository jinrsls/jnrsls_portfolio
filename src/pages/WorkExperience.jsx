export default function WorkExperience() {
  ...
  return (
    <section id="experience" className="px-6 py-20 min-h-screen">
      {/* Title */}
      <h1 className="text-3xl md:text-4xl font-extrabold text-gray-100 mb-12 tracking-wide flex items-center gap-2">
        Experience
      </h1>
